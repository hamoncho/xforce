...
CREATE TABLE `instructor_curso` (
  ...
  CONSTRAINT `instructor_curso_ibfk_1` FOREIGN KEY (`id_Usuario`) REFERENCES `instructor` (`id_Usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `instructor_curso_ibfk_2` FOREIGN KEY (`id_Curso`) REFERENCES `curso` (`id_Curso`) ON DELETE CASCADE ON UPDATE CASCADE
